// Writes corrected passkey Edge Function files with shared CORS imports.
const fs = require('fs');

// ============================================================
// passkey-authenticate/index.ts
// ============================================================
const paContent = [
...
fs.writeFileSync(
  'G:/personal/finance/services/api/supabase/functions/passkey-authenticate/index.ts',
  paContent
);
console.log('passkey-authenticate written');
...
fs.writeFileSync(
  'G:/personal/finance/services/api/supabase/functions/passkey-register/index.ts',
  prContent
);
console.log('passkey-register written');
