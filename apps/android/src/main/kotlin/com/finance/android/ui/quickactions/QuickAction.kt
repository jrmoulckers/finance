...
enum class QuickActionType(
    ...
    QUICK_EXPENSE(
        id = "quick_expense",
        label = "Quick expense",
        contentDescription = "Rugged large-target quick expense for wet or gloved hands",
        route = "rugged-quick-expense",
        iconName = "Bolt",
        baseWeight = 0.37,
    ),
    SCAN_RECEIPT(
        id = "scan_receipt",
        label = "Scan receipt",
        contentDescription = "Scan a receipt and save it as an expense with COGS mapping",
        route = "receipt-expense",
    ...
    BUSINESS_MONEY(
        ...
        contentDescription = "Separate business and personal money and review flagged transactions",
        route = "business-separation",
    ...
    CASH_FORECAST(
        id = "cash_forecast",
        label = "Cash forecast",
        contentDescription = "Forecast whether you can cover payroll, taxes and truck bills",
        route = "cash-forecast",
    ...
    FOOD_TRUCK_PNL(
        id = "food_truck_pnl",
        label = "Food truck P&L",
        contentDescription = "Weekly and monthly food-truck profit and loss with margins",
        route = "food-truck-pnl",
        iconName = "Assessment",
        baseWeight = 0.31,
    ),
    SHARE_WIN(
        id = "share_win",
        label = "Share a win",
        contentDescription = "Share a savings win or badge unlock without exposing balances",
        route = "share-win",
