 ...
 *
 * Displays all fields for a single transaction in a Material 3 card layout:
 * a prominent amount / payee header, a details card (date, category, account, note),
 * and an optional tags section.
 *
 ...
 *
 * Accessibility: every interactive and informational Composable carries a
 * `contentDescription` for full TalkBack / Switch Access compatibility.
 *
