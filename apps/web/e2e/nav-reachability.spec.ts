...
const NAV_DESTINATIONS = [
  ...
  { label: 'Safety', href: '/safety', priority: 9 },
  { label: 'Bills', href: '/bills', priority: 10 },
  { label: 'Investments', href: '/investments', priority: 11 },
  { label: 'Tax Center', href: '/investments/tax', priority: 12 },
  { label: 'Invoices', href: '/invoices', priority: 13 },
  { label: 'Subscriptions', href: '/subscriptions', priority: 13 },
  // Plan
  { label: 'Debt', href: '/debt', priority: 3 },
  { label: 'Budgets', href: '/budgets', priority: 4 },
  { label: 'Goals', href: '/goals', priority: 13 },
  { label: 'Planning', href: '/planning', priority: 14 },
  { label: 'Learning', href: '/learning', priority: 15 },
  { label: 'Estate Inventory', href: '/estate', priority: 16 },
  { label: 'Categories', href: '/categories', priority: 17 },
  // Insights
  ...
  { label: 'Client Profitability', href: '/client-profitability', priority: 24 },
  { label: 'Achievements', href: '/achievements', priority: 25 },
  { label: 'Watchlists', href: '/watchlists', priority: 26 },
  // Connect
