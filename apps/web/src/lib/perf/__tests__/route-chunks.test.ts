...
describe('route chunk mapping', () => {
  it('normalizes Windows module paths', () => {
    expect(normalizeModuleId('G:\\personal\\finance\\apps\\web\\src\\pages\\DashboardPage.tsx')).toContain(
  ...
  it('groups dashboard, import, reports, and settings routes into named chunks', () => {
    ...
    expect(getRouteChunkName('G:/personal/finance/apps/web/src/pages/DataImportWizardPage.tsx')).toBe(
      'route-import',
    );
