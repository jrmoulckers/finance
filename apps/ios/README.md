...
> **CI**: The iOS build requires the `FinanceSync.xcframework` (generated by `./gradlew :packages:sync:assembleFinanceSyncXCFramework`). The CI workflow builds this automatically before running `swift build`.
