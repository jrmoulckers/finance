...
This Code of Conduct applies within all project spaces — including the repository, issue tracker, pull requests, discussions, and any other channel used for project communication. It also applies when an individual is officially representing the project in public spaces.

## Reporting

Report unacceptable behavior by opening a private report via [GitHub's reporting tools](https://docs.github.com/en/communities/maintaining-your-safety-on-github/reporting-abuse-or-spam) or by contacting the maintainer through their [GitHub profile](https://github.com/jrmoulckers).
