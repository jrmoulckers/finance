...
const FUNCTION_ENV_VARS: Record<string, readonly EnvVarSpec[]> = {
  ...
  'revenuecat-webhook': [
    ...
    { name: 'REVENUECAT_PROJECT_ID', type: 'string' },
    { name: 'REVENUECAT_ACCOUNT_ID', type: 'string' },
    { name: 'REVENUECAT_APP_MAP_JSON', type: 'string' },
    { name: 'REVENUECAT_PRODUCT_MAP_JSON', type: 'string' },
