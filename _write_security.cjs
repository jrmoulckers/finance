...
// Remove test file
try { fs.unlinkSync('_test.txt'); } catch {}

const securityChecklist = `# Security Audit Checklist — OWASP MASVS L1
...
fs.writeFileSync('docs/audits/security-checklist.md', securityChecklist);
console.log('Wrote security-checklist.md:', fs.statSync('docs/audits/security-checklist.md').size, 'bytes');
