...
// (4.1.135.Final). Fixes 28 Dependabot security alerts (HTTP/2 attacks, request
// smuggling, DoS, decompression bombs, CRLF injection) across Ktor, Compose
// Desktop, and Gradle Develocity transitive dependency trees. See #1292, #3099.
    ...
    configurations.all {
        resolutionStrategy.eachDependency {
            if (requested.group == "io.netty") {
                ...
                because("Fix Dependabot security alerts for Netty CVEs (#1292, #3099)")
            }
        }
    }
}
