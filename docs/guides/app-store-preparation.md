...
**Key principle:** Prepare store assets *before* code-complete — screenshot automation, privacy documentation, and metadata take longer than expected and should not block launch.
