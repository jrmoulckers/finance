...
All data in transit must be encrypted. The app must not be vulnerable to man-in-the-middle attacks.
...
Authentication follows [ADR-0004](../architecture/0004-auth-security-architecture.md). This section verifies the implementation matches the architecture.
