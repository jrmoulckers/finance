...
| **Required CI status checks**   | A PR cannot merge until the required status checks configured on `main` pass. See [branch-protection.md](../../.github/branch-protection.md) for the current required set.               |
