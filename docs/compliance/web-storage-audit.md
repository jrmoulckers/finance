...
**Source:** `apps/web/src/auth/token-storage.ts` lines 9–10 explicitly state: _"The backend sets tokens via `Set-Cookie` headers. The client NEVER reads or writes token cookies directly."_
