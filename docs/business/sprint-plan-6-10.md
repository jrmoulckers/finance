...
_This document is the source of truth for post-launch sprint execution. Updated after each sprint retrospective. Predecessor: [Sprint Plan 1-5](sprint-plan-1-5.md)._
