...
when_to_use: 'Windows desktop client — Compose Desktop (JVM), Koin DI, DPAPI secure storage, Windows Hello, Narrator accessibility, MSIX packaging and Store submission prep.'
primary_paths:
  - 'apps/windows/**'
write_scope: full
risk_level: medium
