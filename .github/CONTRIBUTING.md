...
2. **GitHub PAT** — For the GitHub MCP server, create a [Personal Access Token](https://github.com/settings/tokens) with `repo` and `read:org` scopes. VS Code will prompt you when needed.
